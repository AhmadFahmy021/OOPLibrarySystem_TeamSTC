...
public class SideBar extends VBox {
    ...
    public SideBar(Index app) {
        ...
        Button btnDataBook = new Button("Data Book");
        ...
        setupSidebarButton(btnDataBook);
        setupSidebarButton(btnBorrowBook);
        ...
        btnDashboard.setOnAction(e -> {
            ...
            app.showDashboardUser(); // Panggil metode di Index untuk menampilkan dashboard
        });

        btnDataBook.setOnAction(e -> {
            setActiveButton(btnDataBook); // Set tombol ini sebagai aktif
            app.showDataBookPage(); // Panggil metode di Index untuk menampilkan halaman Data Book
        });

        btnBorrowBook.setOnAction(e -> {
            setActiveButton(btnBorrowBook); // Set tombol ini sebagai aktif
            // app.showBorrowBookPage(); // Asumsi Anda punya metode ini
            System.out.println("Borrow Book clicked!"); // Placeholder jika belum ada
        }); // Assuming a method to show dashboard

        getChildren().addAll(title, btnDashboard, btnDataBook, btnBorrowBook);
    }
